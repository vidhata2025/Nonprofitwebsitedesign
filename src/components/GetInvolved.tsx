...
import { HandHeart, Users, Building2, Share2 } from 'lucide-react';
...
export function GetInvolved() {
  const opportunities = [
    ...
    },
    {
      icon: HandHeart,
      title: 'Donate',
      description: 'Your financial support helps us expand our reach and provide quality learning experiences to more students.',
      cta: 'Make a Donation',
      color: 'bg-[#EA8166]',
    ...
    },
    {
      ...
      description: 'Help us reach more students and volunteers by sharing our mission with your network.',
  ...
  return (
    <section id="get-involved" className="py-20 bg-gradient-to-b from-[#F0F9F9] to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-[#5B8A8D] text-lg mb-3 tracking-wide">GET INVOLVED</h2>
          <h3 className="text-4xl sm:text-5xl text-gray-900 mb-6">
            Be Part of the Change
          </h3>
          <p className="text-gray-600 text-lg max-w-3xl mx-auto">
            There are many ways to support our mission and help empower underserved students 
            across Nepal. Every contribution makes a meaningful difference.
          </p>
        </div>
            ...
            return (
              ...
              >
                <CardHeader className="text-center pb-4">
                  <div className={`w-20 h-20 ${opportunity.color} rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform shadow-lg`}>
        ...
        {/* Impact Statement */}
        <div className="bg-white rounded-2xl shadow-xl p-10 sm:p-16 border-t-4 border-[#EA8166]">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 text-lg mb-4">
                Every volunteer hour, every donation, and every partnership helps us reach 
                more students and create lasting change in communities across Nepal.
              </p>
              <p className="text-gray-600 text-lg">
                With your support, we can continue to provide quality non-academic learning 
                experiences that transform lives and build stronger, more resilient communities.
              </p>
            </div>
